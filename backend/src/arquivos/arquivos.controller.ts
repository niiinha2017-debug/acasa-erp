...
export class ArquivosController {
  ...
  listar(
    ...
    if (!owner_type || !oid) {
      throw new BadRequestException('owner_type e owner_id são obrigatórios para listar.')
    }
  ...
  async upload(
    ...
    if (!body.owner_type || !oid) {
      ...
      throw new BadRequestException('owner_type e owner_id são obrigatórios no body.')
    }
