  ...
  <div class="page-container">
    <Card>
      <header class="card-header">
        <div>
          <h2 class="card-title">Nova Constante</h2>
          <p style="font-size: var(--font-size-sm); margin: 0; opacity: .85;">
            Cadastre uma constante para uso em selects, status e regras do sistema.
          </p>
        </div>
      </header>
      ...
      <div style="padding: 16px 20px;">
        <form class="form-grid" @submit.prevent="salvar">
          <div class="col-span-12">
            <p style="margin: 0; font-size: var(--font-size-sm); opacity: .85;">
              Dica: mantenha <b>categoria</b> e <b>chave</b> estáveis.
              O <b>rótulo</b> é o texto exibido.
            </p>
          </div>
