  ...
  <div class="w-full h-full">
    <div class="relative overflow-hidden rounded-2xl border border-border-ui bg-bg-card">
      ...
      <div class="px-4 md:px-6 pb-6 pt-4 border-t border-border-ui space-y-8">
        ...
        <!-- Fechamento: custo devido -->
        <section v-if="atalhosResumo.length">
          <h2 class="text-[10px] font-black uppercase tracking-wider text-text-soft mb-3 flex items-center gap-2">
...
// Fechamento de Folha Operacional: feriados + fechamento + pagamento (uma página única)
const atalhosResumo = computed(() =>
  [
    {
      label: 'Fechamento de Folha Operacional',
      desc: 'Feriados · Fechamento · Pagamento — ganhos, vales e recibo em PDF',
      to: '/rh/folha-operacional',
      icon: 'pi pi-wallet',
      show: () => can('ponto_relatorio.ver'),
    },
  ].filter((item) => item.show()),
