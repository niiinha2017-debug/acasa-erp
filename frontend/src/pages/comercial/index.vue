<template>
  <div class="w-full h-full">
    <div class="relative overflow-hidden rounded-2xl border border-border-ui bg-bg-card">
      ...
      <PageHeader
        title="Comercial"
        subtitle="Orçamentos, vendas e contratos"
      ...
      <div class="px-4 md:px-6 pb-5 md:pb-6 pt-4 border-t border-border-ui space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 class="text-base font-bold text-text-main uppercase tracking-tight mb-1">Venda</h3>
            <p class="text-xs text-text-soft">Pedidos e faturamento</p>
          </RouterLink>
...
const temAlgumAcesso = computed(() =>
  can('orcamentos.ver') || can('vendas.ver') || can('contratos.ver')
)
</script>
