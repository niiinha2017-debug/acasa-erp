...
--
-- Host: 127.0.0.1    Database: acasa_erp
-- ------------------------------------------------------
...
--
-- Dumping data for table `agenda_producao`
--

LOCK TABLES `agenda_producao` WRITE;
/*!40000 ALTER TABLE `agenda_producao` DISABLE KEYS */;
/*!40000 ALTER TABLE `agenda_producao` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ambientes_venda`
--

LOCK TABLES `ambientes_venda` WRITE;
/*!40000 ALTER TABLE `ambientes_venda` DISABLE KEYS */;
/*!40000 ALTER TABLE `ambientes_venda` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `apontamento_producao`
--

LOCK TABLES `apontamento_producao` WRITE;
/*!40000 ALTER TABLE `apontamento_producao` DISABLE KEYS */;
/*!40000 ALTER TABLE `apontamento_producao` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `entrada_insumos`
--

LOCK TABLES `entrada_insumos` WRITE;
/*!40000 ALTER TABLE `entrada_insumos` DISABLE KEYS */;
/*!40000 ALTER TABLE `entrada_insumos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `estoque_sobras`
--

LOCK TABLES `estoque_sobras` WRITE;
/*!40000 ALTER TABLE `estoque_sobras` DISABLE KEYS */;
/*!40000 ALTER TABLE `estoque_sobras` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `insumos_plano_corte`
--

LOCK TABLES `insumos_plano_corte` WRITE;
/*!40000 ALTER TABLE `insumos_plano_corte` DISABLE KEYS */;
/*!40000 ALTER TABLE `insumos_plano_corte` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `itens_compra_rateio`
--

LOCK TABLES `itens_compra_rateio` WRITE;
/*!40000 ALTER TABLE `itens_compra_rateio` DISABLE KEYS */;
/*!40000 ALTER TABLE `itens_compra_rateio` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `itens_plano_corte`
--

LOCK TABLES `itens_plano_corte` WRITE;
/*!40000 ALTER TABLE `itens_plano_corte` DISABLE KEYS */;
/*!40000 ALTER TABLE `itens_plano_corte` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `orcamento_ambientes`
--

LOCK TABLES `orcamento_ambientes` WRITE;
/*!40000 ALTER TABLE `orcamento_ambientes` DISABLE KEYS */;
/*!40000 ALTER TABLE `orcamento_ambientes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `orcamento_opcoes`
--

LOCK TABLES `orcamento_opcoes` WRITE;
/*!40000 ALTER TABLE `orcamento_opcoes` DISABLE KEYS */;
/*!40000 ALTER TABLE `orcamento_opcoes` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `permissions` VALUES (1,'clientes.ver','Visualizar clientes'),(2,'clientes.criar','Criar clientes'),(3,'clientes.editar','Editar clientes'),(4,'clientes.excluir','Excluir clientes');
...
--
-- Dumping data for table `planos_corte`
--

LOCK TABLES `planos_corte` WRITE;
/*!40000 ALTER TABLE `planos_corte` DISABLE KEYS */;
/*!40000 ALTER TABLE `planos_corte` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ponto_justificativas`
--

LOCK TABLES `ponto_justificativas` WRITE;
/*!40000 ALTER TABLE `ponto_justificativas` DISABLE KEYS */;
/*!40000 ALTER TABLE `ponto_justificativas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `roles` VALUES (1,'admin','Administrador',1);
...
--
-- Dumping data for table `solicitacoes_cadastro`
--

LOCK TABLES `solicitacoes_cadastro` WRITE;
/*!40000 ALTER TABLE `solicitacoes_cadastro` DISABLE KEYS */;
/*!40000 ALTER TABLE `solicitacoes_cadastro` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tarefas_funcionarios`
--

LOCK TABLES `tarefas_funcionarios` WRITE;
/*!40000 ALTER TABLE `tarefas_funcionarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `tarefas_funcionarios` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tarefas_producao`
--

LOCK TABLES `tarefas_producao` WRITE;
/*!40000 ALTER TABLE `tarefas_producao` DISABLE KEYS */;
/*!40000 ALTER TABLE `tarefas_producao` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (2,'Admin','admin@acasa.com','$2a$10$mHUc70PwMsePEcqppX.3eeHSSH9tYaoUA35q9zeW1WeJY0AJ5aPYS','2025-12-12 15:37:31.250875',1);
...
-- Dump completed on 2025-12-19  8:23:47
